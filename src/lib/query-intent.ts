...
- 注意: 「ジョブメドレー 求人」はtransactional、「ジョブメドレー」単体がbranded_media

#### 2. branded_customer（指名検索・顧客）
**病院・クリニック・施設・法人名**を単体で検索している（求人・採用なし）。
- 「聖路加国際病院」「〇〇クリニック」「〇〇法人」「△△会」など施設・法人名のみ
- SERPに特定の医療機関・施設の公式サイトが上位を占める
- 注意: 「聖路加国際病院 求人」はtransactional、「聖路加国際病院」単体がbranded_customer
...
**重要なルール**: 「求人」「転職」「募集」「採用」が含まれるキーワードは、たとえ媒体名や施設名が含まれていても transactional です。

検索キーワードを以下の6つの意図カテゴリに分類してください：

## 1. branded_media（指名検索：媒体）
競合求人媒体・転職サイト名を**単体で**検索している。
- 例: 「ジョブメドレー」「マイナビ看護師」「ナース人材バンク」「Indeed」
- 注意: 「ジョブメドレー 求人」→ transactional（求人が付くと応募意図）

## 2. branded_customer（指名検索：顧客）
病院・クリニック・施設・法人名を**単体で**検索している（求人・採用なし）。
- 例: 「聖路加国際病院」「〇〇クリニック」「医療法人〇〇会」
- 注意: 「聖路加国際病院 求人」→ transactional（求人が付くと応募意図）

## 3. branded_ambiguous（指名検索：曖昧）
固有名詞だが、同名の複数組織/サービスが存在し特定できない。
- 例: 「れいんぼー」「charom」「ABC」（同名の別組織が複数存在）
- 1つに特定できればbranded_mediaかbranded_customer

## 4. transactional（応募意図）
求人への応募・転職意図が明確。「求人」「転職」「募集」「採用」を含む。
- 例: 「看護師 求人」「介護職 転職」「〇〇病院 求人」「ジョブメドレー 求人」
